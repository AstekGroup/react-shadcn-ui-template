...
export const LampEffect = ({ className, children }: LampEffectProps) => {
  return (
    <div
      className={cn(
        'relative flex min-h-[300px] flex-col items-center justify-center overflow-hidden rounded-xl bg-slate-950 w-full',
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        <motion.div
          ...
          className="bg-linear-to-b absolute inset-auto right-1/2 h-56 overflow-visible from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="bg-linear-to-b absolute inset-auto left-1/2 h-56 from-transparent via-transparent to-cyan-500 text-white [--conic-position:from_290deg_at_center_top]"
        >
